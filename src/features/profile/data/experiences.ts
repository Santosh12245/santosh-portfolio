...
export const EXPERIENCES: Experience[] = [
  {
    ...
    companyName: "iServeU",
    companyLogo:
      // "https://iserveu.in/wp-content/uploads/2024/01/iserveu-logo.png",
      "/images/comp-logo/iserveu.png",
    positions: [
      {
        id: "iserveu-fulltime-2024",
        ...
        employmentType: "Full-time",
        icon: "code",
        description: `- Designed, developed, and optimized **DMT (Domestic Money Transfer)**, **BBPS (Bharat Bill Payment System)**, and **NSDL modules**.
- Implemented **Spring Boot microservices** ensuring scalability, security, and high performance.
- Integrated **REST APIs** for financial transactions and ensured compliance with regulatory standards.
- Improved transaction success rate by optimizing business logic and database queries.
- Collaborated with QA and DevOps teams to deliver reliable, production-ready services.`,
        skills: [
          "Spring Boot",
          "Java",
          "Microservices",
      ...
      },
      {
        ...
        icon: "code",
        description: `- Gained hands-on experience working with **Apache Fineract**, focusing on digital financial services.
- Managed **Gradle builds** and configured **Docker containers** for smooth deployment.
- Assisted in designing reusable services and contributing to **FinTech product architecture**.
- Enhanced debugging and troubleshooting skills by analyzing large-scale financial transaction logs.`,
        skills: [
          "Apache Fineract",
          "Gradle",
          "Docker",
  ...
  },
  {
    id: "jio",
    companyName: "Jio",
    companyLogo: "/images/comp-logo/jio.svg",
    positions: [
      {
        id: "jio-intern-2023",
        ...
        employmentType: "Internship",
        icon: "idea",
        description: `- Analyzed **large datasets** from call center operations to identify inefficiencies.
- Created dashboards and visual reports to monitor KPIs and customer satisfaction metrics.
- Suggested actionable strategies that improved **agent productivity** and **customer experience**.
- Worked closely with business stakeholders to deliver insights in real time.`,
        skills: [
          "Data Analysis",
          "SQL",
          "Excel",
  ...
  //     companyLogo: "https://internpe.in/assets/img/logo.png", // Replace with real if available
  //     positions: [
  //       {
  //         id: "internpe-intern-2023",
  ...
  //         employmentType: "Internship",
  //         icon: "code",
  //         description: `- Developed and styled **interactive websites and web applications**.
  // - Built a **Landing Page for VSSUT MCA** using **HTML, CSS, JavaScript, and GSAP animations**.
  // - Ensured **cross-browser compatibility** and responsiveness for different devices.
  // - Collaborated with designers, PMs, and other engineers to transform creative concepts into production-ready websites.
  // - Improved front-end performance through **code optimization** and **best practices**.`,
  //         skills: [
  //           "HTML",
  //           "CSS",
  //           "JavaScript",
  ...
  //   },
  {
    id: "emertxe",
    companyName: "Emertxe",
    companyLogo: "/images/comp-logo/emertxe.png", // Replace if you have exact
    positions: [
      {
        id: "emertxe-intern-2023",
        ...
        employmentType: "Internship",
        icon: "idea",
        description: `- Built strong **programming foundations** in C and embedded systems.
- Worked with **Micro-Controllers** for real-world hardware programming.
- Developed a **full SDLC-based IoT project**, including requirement analysis, design, coding, testing, and deployment.
- Gained practical exposure to **embedded C programming**, debugging, and hardware interfacing.`,
        skills: [
          "C Programming",
          "Embedded Systems",
          "Microcontrollers",
